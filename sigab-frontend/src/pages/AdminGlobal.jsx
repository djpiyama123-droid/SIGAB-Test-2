...
const SUSCRIPCION_BADGE = {
  ...
  inactivo: {
    dot: 'bg-slate-500',
    pill: 'bg-slate-500/15 text-[var(--content-muted)] border border-slate-500/25',
    label: 'Inactivo',
  },
};
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <button
          onClick={cargar}
          disabled={loading}
          className="flex items-center gap-2 text-sm px-3 py-2 rounded-xl bg-[var(--content-surface)] border border-[var(--content-border)] text-[var(--content-muted)] hover:text-[var(--content-text)] hover:bg-[var(--content-bg)] transition-all disabled:opacity-40"
        >
      ...
      <section aria-label="KPIs globales">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KPICard
            ...
            colorClass="text-[var(--content-text)]"
          />
        </div>
      </section>
                ...
                hospitales.map((h) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5">
                      <code className="text-xs font-mono px-1.5 py-0.5 rounded bg-slate-500/15 text-[var(--content-muted)]">
                        {h.slug}
                      </code>
                    </td>
                    <td className="px-4 py-3.5">
