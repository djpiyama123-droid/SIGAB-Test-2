...
const STATUS_CONFIG = {
  ...
  baja:             { color: '#64748b', bg: 'var(--content-surface)', label: 'Baja', icon: '✕' },
};
  ...
  return (
    <div className="min-h-screen bg-[var(--content-bg)] text-[var(--content-text)]">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        {/* Datos Técnicos */}
        <div className="bg-[var(--content-bg)] rounded-xl border border-[var(--content-border)] divide-y divide-[var(--content-border)]">
        ...
        <div className="bg-[var(--content-bg)] rounded-xl border border-[var(--content-border)] divide-y divide-[var(--content-border)]">
          ...
          <div className="px-4 py-2.5 flex justify-between items-center">
            ...
            <span className={`text-sm font-semibold ${mantenimientoVencido ? 'text-red-600' : 'text-emerald-600'}`}>
            ...
            <div className="px-4 py-3 flex gap-3">
              {equipo.manual_url && (
                <a href={equipo.manual_url} target="_blank" rel="noreferrer"
                  className="flex-1 py-2 rounded-lg bg-blue-600/10 text-blue-700 text-xs font-semibold text-center hover:bg-blue-600/20 transition-colors border border-blue-600/30">
                  📄 Manual
                </a>
              )}
              {equipo.video_url && (
                <a href={equipo.video_url} target="_blank" rel="noreferrer"
                  className="flex-1 py-2 rounded-lg bg-purple-600/10 text-purple-700 text-xs font-semibold text-center hover:bg-purple-600/20 transition-colors border border-purple-600/30">
                  🎬 Video
                </a>
              )}
            </div>
