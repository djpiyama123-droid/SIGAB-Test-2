            ...
            <div className="bg-[var(--content-bg)] rounded-2xl border border-blue-500/30 p-6 space-y-6 animate-in slide-in-from-right-4 duration-300">
                      ...
                      {['SI', 'NO', 'N/A'].map(val => (
                        <label key={val} className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 text-blue-600 bg-[var(--content-surface)] border-[var(--content-border)] focus:ring-blue-500"
                          />
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-[var(--content-text)] flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-95 ${
                  loading ? 'bg-[var(--content-surface)]' : 'bg-blue-600 hover:bg-blue-500'
                }`}
              >
              ...
              {history.map(h => (
                <div key={h.id} className="p-3 rounded-xl bg-[var(--content-surface)] border border-[var(--content-border)]">
                  <div className="flex justify-between items-start mb-1">
                    <span className="text-[10px] uppercase font-bold text-blue-600">{h.checklist_nombre}</span>
