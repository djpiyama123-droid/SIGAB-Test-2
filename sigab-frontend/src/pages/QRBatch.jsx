    ...
    <div className="p-4 md:p-6 space-y-6 qr-batch-screen">
      ...
      <div className="flex flex-wrap gap-3 print:hidden">
        ...
        <div className="flex items-center gap-2 bg-[var(--content-surface)] px-4 py-2 rounded-xl border border-[var(--content-border)]/50">
          ...
          <span className={`font-bold text-lg ${modo === 'carta' ? 'text-purple-600' : 'text-amber-600'}`}>
        ...
        {seleccionados.length > 0 && (
          <button
            ...
            className="flex items-center gap-2 ml-auto bg-[var(--content-surface)] hover:bg-[var(--content-bg)] text-[var(--content-text)] px-4 py-2 rounded-xl text-sm font-medium transition-all"
          >
      ...
      <div className="flex flex-wrap gap-3 print:hidden bg-[var(--content-surface)] p-4 rounded-2xl border border-[var(--content-border)]">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[var(--content-surface)] hover:bg-[var(--content-bg)] text-[var(--content-text)] px-4 py-2.5 rounded-lg text-sm font-medium transition-all"
        >
          {allVisibleSelected ? <CheckSquare className="h-4 w-4 text-purple-600" /> : <Square className="h-4 w-4" />}
        ...
        {seleccionados.length > 0 && (
          <button
            ...
            className="text-red-600 hover:text-red-700 px-3 py-2 text-sm font-medium transition-all"
          >
              ...
              return (
                <div
                  ...
                  className={`group cursor-pointer p-3 border rounded-xl transition-all duration-200 ${
                    selected
                      ? 'bg-purple-50 border-purple-500 shadow-lg shadow-purple-500/10 ring-1 ring-purple-500/20'
                      : 'bg-[var(--content-surface)] border-[var(--content-border)]/50 hover:border-[var(--content-border)] hover:bg-[var(--content-bg)]'
                  }`}
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className={`ml-2 transition-all duration-200 ${selected ? 'opacity-100' : 'opacity-0 group-hover:opacity-40'}`}>
                      <CheckCircle className={`h-4 w-4 ${selected ? 'text-purple-600' : 'text-[var(--content-muted)]'}`} />
                    </div>
                  </div>
                </div>
              );
