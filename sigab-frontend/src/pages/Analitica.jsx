  ...
  if (loading) {
    return (
      <div className="flex h-64 items-center justify-center">
        <div className="h-12 w-12 animate-spin rounded-full border-4 border-[var(--content-border)] border-t-emerald-500" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="bg-emerald-50 text-emerald-700 text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border border-emerald-200">
              Métricas Predictivas
            </span>
            <span className="bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border border-blue-200 flex items-center gap-1">
        ...
        <div className="flex gap-2">
           <button
             ...
             className="p-2 bg-[var(--content-surface)] hover:bg-[var(--content-border)] text-[var(--content-muted)] rounded-xl transition-all active:scale-90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-[var(--content-bg)]/50 border border-[var(--content-border)] p-6 rounded-3xl relative overflow-hidden group hover:border-emerald-500/30 transition-all">
        ...
        <div className="bg-[var(--content-bg)]/50 border border-red-500/30 p-6 rounded-3xl relative overflow-hidden group hover:border-red-400 transition-all">
          <div className="relative z-10">
            ...
            <p className="text-[10px] text-red-600 font-bold mt-2">Acción inmediata requerida</p>
          </div>
          <AlertTriangle className="absolute -bottom-4 -right-4 h-24 w-24 text-red-500/5 group-hover:text-red-500/10 transition-colors" />
        </div>

        <div className="bg-[var(--content-bg)]/50 border border-[var(--content-border)] p-6 rounded-3xl relative overflow-hidden group hover:border-blue-500/30 transition-all">
          <div className="relative z-10">
            ...
            <p className="text-[10px] text-[var(--content-muted)] font-bold mt-2">Intervalo de estabilidad técnica</p>
          </div>
          <Clock className="absolute -bottom-4 -right-4 h-24 w-24 text-blue-500/5 group-hover:text-blue-500/10 transition-colors" />
        </div>

        <div className="bg-[var(--content-bg)]/50 border border-[var(--content-border)] p-6 rounded-3xl relative overflow-hidden group hover:border-purple-500/30 transition-all">
          <div className="relative z-10">
      ...
      <div className="bg-[var(--content-bg)]/40 border border-[var(--content-border)] rounded-3xl overflow-hidden shadow-2xl shadow-black/50">
        <div className="p-6 border-b border-[var(--content-border)] flex justify-between items-center bg-[var(--content-bg)]/20">
          <h2 className="text-lg font-bold text-[var(--content-text)]">Heatmap de Fiabilidad Operativa</h2>
          <div className="flex items-center gap-4 text-[10px] font-bold text-[var(--content-muted)] uppercase">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-[var(--content-bg)]/60 transition-colors">
              <tr>
                <th className="px-6 py-4 text-[10px] font-black uppercase text-[var(--content-muted)] tracking-widest">Activo / Serie</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase text-[var(--content-muted)] tracking-widest text-center">Prob. Falla</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase text-[var(--content-muted)] tracking-widest text-center">MTBF (D)</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase text-[var(--content-muted)] tracking-widest text-center">MTTR (H)</th>
                <th className="px-6 py-4 text-[10px] font-black uppercase text-[var(--content-muted)] tracking-widest text-right">Estatus I.A.</th>
              </tr>
            </thead>
                  ...
                  <tr key={m.equipo_id} className="hover:bg-[var(--content-surface)] transition-all group">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex flex-col items-center gap-2">
                        <div className="w-32 bg-[var(--content-surface)] h-1.5 rounded-full overflow-hidden">
                          <div 
