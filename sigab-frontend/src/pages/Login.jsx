  ...
  return (
    <div className="min-h-screen bg-[var(--content-bg)] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-[var(--content-text)]">
          SIGAB
        </h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full appearance-none rounded-md border border-[var(--content-border)] bg-[var(--content-surface)] px-3 py-2 text-[var(--content-text)] placeholder:text-[var(--content-muted)] shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-emerald-500 sm:text-sm"
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="flex w-full justify-center rounded-md border border-transparent bg-emerald-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-[var(--content-bg)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
