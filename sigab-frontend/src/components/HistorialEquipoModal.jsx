  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="historial-equipo-title"
      ...
      >
        ...
        <div className="p-5 border-b border-[var(--content-border)] flex justify-between items-start">
          <div>
            <h2 id="historial-equipo-title" className="text-lg font-bold text-[var(--content-text)]">Historial Técnico</h2>
      ...
      {ordenes.map((os) => (
        <div key={os.id} className="bg-[var(--content-bg)]/50 border border-[var(--content-border)] rounded-lg p-4">
          <div className="flex justify-between items-start mb-2">
            <div>
              <p className="font-mono text-emerald-600 text-sm">{os.numero_orden}</p>
      ...
      {traslados.map((t) => (
        <div key={t.id} className="bg-[var(--content-bg)]/50 border border-[var(--content-border)] rounded-lg p-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs border border-blue-200">
              {t.area_destino}
