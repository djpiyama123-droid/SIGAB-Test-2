...
const ESTADOS_FINALES = [
  { value: 'operativo',      label: '🟢 Operativo',                badge: 'bg-emerald-50 text-emerald-700 border-emerald-300' },
  { value: 'operativo_obs',  label: '🟡 Operativo c/observaciones', badge: 'bg-yellow-50 text-yellow-700 border-yellow-300' },
  { value: 'fuera_servicio', label: '🔴 Fuera de servicio',         badge: 'bg-red-50 text-red-700 border-red-300' },
  { value: 'en_taller',      label: '🔵 En taller',                 badge: 'bg-blue-50 text-blue-700 border-blue-300' },
];
        ...
        return (
          ...
          >
            <span className={`w-4 h-4 rounded border-2 flex-shrink-0 flex items-center justify-center
              ${marcado ? 'border-orange-400 bg-orange-100' : 'border-[var(--content-border)]'}`}>
              {marcado && <span className="text-orange-600 text-xs leading-none">✓</span>}
            </span>
            <input
              type="checkbox"
              className="sr-only"
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--content-border)] sticky top-0 bg-[var(--content-bg)] z-10 rounded-t-2xl">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-lg border border-[var(--content-border)] text-[var(--content-muted)] hover:border-teal-500 hover:text-teal-700 transition-colors"
              >
                🖨 Imprimir hoja
              </button>
              {ordenId && (
          ...
          <form onSubmit={handleGuardar} className="p-6 space-y-6">
            ...
            {!ordenIdProp && (
              <section className="bg-blue-50 border border-blue-200 rounded-xl p-4 space-y-3">
                <h3 className="text-xs font-semibold uppercase tracking-widest text-blue-700 mb-1">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    className="w-full bg-[var(--content-surface)] border border-[var(--content-border)] rounded-lg px-3 py-2 text-sm text-[var(--content-text)] placeholder:text-[var(--content-muted)] focus:border-teal-500 focus:outline-none resize-none"
                    rows={3}
                    maxLength={140}
            ...
            <section className="border border-dashed border-[var(--content-border)] rounded-xl p-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  onClick={handleOCR}
                  className="px-4 py-1.5 text-xs rounded-lg bg-teal-600 border border-teal-500 text-white hover:bg-teal-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
            ...
            {exito && (
              <div className="bg-emerald-50 border border-emerald-300 rounded-lg px-4 py-3 text-sm text-emerald-700">
