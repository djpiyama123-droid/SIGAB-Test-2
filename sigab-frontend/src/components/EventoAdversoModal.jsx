    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          {paso === 1 && (
            <>
              <h3 className="text-sm font-semibold text-red-600">1. Identificacion del dispositivo</h3>
          ...
          {paso === 2 && (
            <>
              <h3 className="text-sm font-semibold text-red-600">2. Datos del evento</h3>
          ...
          {paso === 3 && (
            <>
              <h3 className="text-sm font-semibold text-red-600">3. Paciente y estado del dispositivo</h3>
              ...
              <div className="bg-[var(--content-bg)]/50 border border-red-500/30 rounded-lg p-4 space-y-2">
                <p className="text-xs text-red-600 font-semibold">Resumen del reporte</p>
                <div className="grid grid-cols-2 gap-1 text-xs text-[var(--content-muted)]">
                  ...
                  <span>Severidad: <strong className={
                    form.severidad === 'critica' ? 'text-red-600' :
                    form.severidad === 'grave' ? 'text-orange-600' : 'text-yellow-600'
