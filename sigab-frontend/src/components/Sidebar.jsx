    ...
    >
      ...
      >
        <div>
          ...
          <p className="text-xs mt-0.5 ml-9" style={{ color: 'var(--sidebar-muted)' }}>
            Activos Biomédicos
          </p>
        </div>
        ...
        {NAV_ITEMS.map((item) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              border: isActive ? '1px solid var(--sidebar-active)' : '1px solid transparent',
      ...
      <div className="p-4" style={{ borderTop: '1px solid var(--sidebar-border)' }}>
        <div className="text-xs leading-relaxed" style={{ color: 'var(--sidebar-faint)' }}>
          <p className="font-medium" style={{ color: 'var(--sidebar-muted)' }}>IMSS 1 Clínica General Tijuana</p>
          <p className="mt-0.5">v3.0 · On-Premise</p>
        </div>
      </div>
    </aside>
  );
