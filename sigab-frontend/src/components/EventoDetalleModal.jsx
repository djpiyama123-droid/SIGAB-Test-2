                    ...
                    <div className="bg-[var(--content-bg)] border border-yellow-500/30 p-4 rounded-lg space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={handleInvestigar}
                          className="flex-1 py-1.5 bg-yellow-600 text-[var(--content-text)] font-semibold rounded text-sm hover:bg-yellow-500">Guardar</button>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="bg-[var(--content-bg)] border border-orange-500/30 p-4 rounded-lg space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={handleEscalar}
                          className="flex-1 py-1.5 bg-orange-600 text-[var(--content-text)] font-semibold rounded text-sm hover:bg-orange-500">Escalar</button>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="bg-[var(--content-bg)] border border-emerald-500/30 p-4 rounded-lg space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={handleCerrar}
                          className="flex-1 py-1.5 bg-emerald-600 text-[var(--content-text)] font-semibold rounded text-sm hover:bg-emerald-500">Cerrar</button>
                      </div>
                    </div>
                  )}
