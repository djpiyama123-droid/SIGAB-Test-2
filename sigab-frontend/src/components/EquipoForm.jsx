...
function inputCls(error) {
  return `w-full bg-[var(--content-bg)] border rounded-lg px-3 py-2 text-sm text-[var(--content-text)] placeholder-[var(--content-muted)] focus:outline-none transition-colors ${
