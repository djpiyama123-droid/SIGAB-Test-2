                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full rounded-md border border-[var(--content-border)] bg-[var(--content-bg)] px-3 py-2 text-[var(--content-text)] placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 sm:text-sm"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[var(--content-muted)] mb-1">
