...
const VARIANTS = {
  ...
  glass:
    'glass-panel text-cyan-glow hover:text-[var(--content-text)]',
  ghost:
    'bg-transparent text-on-surface-variant hover:bg-white/5 hover:text-[var(--content-text)] border border-transparent',
  danger:
