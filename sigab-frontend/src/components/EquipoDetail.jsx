      ...
      >
        ...
        >
          ...
          <div className="p-6 border-b border-[var(--content-border)] flex justify-between items-start flex-shrink-0">
            ...
            <button onClick={onClose} aria-label="Cerrar" className="text-[var(--content-muted)] hover:text-[var(--content-text)] p-1">
          ...
          <div className="p-4 border-t border-[var(--content-border)] flex justify-between items-center bg-[var(--content-bg)]/40 rounded-b-2xl flex-shrink-0">
            <button
              ...
              className="px-4 py-2 min-h-[44px] text-red-400 hover:text-red-300 text-sm font-medium flex items-center gap-2 hover:bg-red-900/20 rounded-lg transition-colors"
            >
            ...
            <div className="flex flex-wrap justify-end gap-2">
              ...
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 min-h-[44px] bg-[var(--content-surface)] hover:bg-[var(--content-border)] text-[var(--content-text)] text-sm rounded-lg transition-colors flex items-center justify-center"
              >
                Cerrar
              </button>
              <button
                ...
                className="px-4 py-2 min-h-[44px] bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
