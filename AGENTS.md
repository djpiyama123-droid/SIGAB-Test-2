...
- **Base de datos:** MySQL 8.0 — base `sigah` con 19 tablas
...
## 5. Capacidades del agente SIGAH
...
- **Resumen ejecutivo IA:** análisis del estado SIGAH → resumen narrativo para jefatura
...
### 5.2 Bot Telegram `@sigah_imss_tj_bot`
...
| Rol | Descripción |
|---|---|
| Administrador SIGAH | Acceso total, gestión de usuarios y configuración |
...
Credenciales demo: `ADMIN001 / sigah_admin_2026`
...
Ver `workspace/SOUL.md`, `workspace/IDENTITY.md` y `workspace/USER.md` en el volumen `openclaw_data`. Esos archivos definen la identidad *SIGAH Copilot* y el contexto institucional que carga OpenClaw automáticamente.
...
SIGAH_PUBLIC_BASE_URL=https://sigah.129-121-100-147.sslip.io
SIGAH_GEMMA_MODEL=gemma3:4b
SIGAH_QWEN_MODEL=qwen2.5:7b
...
- Cuando el código o doc dice **SIGAH**, se refiere a la instancia desplegada en HGR No.1 (legacy/single-tenant). Mantener.
