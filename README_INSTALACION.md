...
sudo mysql -e "ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'REDACTED_DB_ROOT_PASS';"

# Crear usuario y base de datos
sudo mysql -u root -pREDACTED_DB_ROOT_PASS -e "
...
mysql -u sigah_user -pREDACTED_DB_PASS sigah < database/sigah_schema_fresh.sql

# Migraciones adicionales (mapa, QR, etc.)
mysql -u sigah_user -pREDACTED_DB_PASS sigah < database/migrations/004_mapa_interactivo.sql
mysql -u sigah_user -pREDACTED_DB_PASS sigah < database/migrations/004_seed_hgr1.sql

# BD real del hospital (datos de equipos)
mysql -u sigah_user -pREDACTED_DB_PASS dummyequipomedicoimss < BaseDeDatosV2_190326.sql
