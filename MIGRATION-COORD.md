# MIGRATION-COORD.md — Coordinación de migración v3.0 (dark → Verde-Blanco IMSS)

> **NOTA — 2026-07-01:** Este archivo fue **borrado en el commit `95af8ac`** (`chore: marcar todos los pasos post-migración como completados`) y **restaurado manualmente** por Hermes desde el commit original `51f2a61` (2026-06-19). Se conserva como **registro histórico** de la migración v3.0. El changelog consolidado y vigente está en [`docs/releases/v3.0.md`](docs/releases/v3.0.md). No editar este archivo como doc vivo — los cambios nuevos de tema van a `docs/releases/vX.Y.md`.
