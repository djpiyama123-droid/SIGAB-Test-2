...
echo
echo "Proximos pasos:"
echo "  1) Verificar par:   ssh sigab-vps 'tailscale status'"
echo "  2) Probar agente:   cd /opt/sigab && claude --version"
echo "  3) Autenticar:      claude login"
echo "  4) (opcional) docker sin sudo: sudo usermod -aG docker \$SUDO_USER y re-login"
echo ""
echo "  NOTA: NO correr 'tailscale up --ssh' en la VPS de produccion —"
echo "  reencamina el puerto 22 y corta el acceso SSH clasico existente."
echo "============================================================"