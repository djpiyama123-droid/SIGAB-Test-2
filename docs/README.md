...
Diagramas de flujo, organigramas e infraestructura del sistema.
...
Estrategia, planes maestros y documentación de negocio.
...
Secciones del estudio técnico del proyecto.

| Sección | Documento |
|---------|-----------|
| 3.1 | [Diagrama de Proceso](estudios_tecnicos/Seccion_3.1_DiagramaProceso.md) |
| 3.2 | [Maquinaria y Equipo](estudios_tecnicos/Seccion_3.2_MaquinariaEquipo.md) |
| 3.3 | [Mano de Obra](estudios_tecnicos/Seccion_3.3_ManoDeObra.md) |
...
Análisis financiero y evaluación de inversión.

| Sección | Documento |
|---------|-----------|
| 4.1 | [Costos de Producción](estudios_economicos/4_1_Costos_de_Produccion.md) |
| 4.2 | [Inversión Inicial](estudios_economicos/4_2_Inversion_Inicial.md) |
...
Planes de instalación, go-live y operación en campo.

| Documento | Descripción |
|-----------|-------------|
| [Plan Go-Live 15 Abr 2026](operacion/PLAN_GO_LIVE_15ABR2026.md) | Checklist completo de go-live |
...
Material para presentaciones ejecutivas.
...
| Documento | Descripción |
|-----------|-------------|
| [Referencia de Endpoints](api/endpoints.md) | Todos los endpoints del backend documentados |
...
| Documento | Descripción |
|-----------|-------------|
| [Manual Técnico](MANUAL_TECNICO.md) | Guía técnica del sistema |
| [Manual de Usuario IA](MANUAL_USUARIO_IA.md) | Guía del módulo Copilot |
| [Diagramas Lógicos](DIAGRAMAS_LOGICOS.md) | Diagramas lógicos del sistema |
| [Plan de Trabajo Maestro](PLAN_DE_TRABAJO_MAESTRO.md) | Cronograma general |
| [Plan Pruebas WhatsApp](PLAN_PRUEBAS_WHATSAPP.md) | Protocolo de pruebas del bot |
