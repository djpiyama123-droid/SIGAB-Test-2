...
4. ✅ Resuelto (`ChecklistPage.jsx`, `Dashboard.jsx`, `Ordenes.jsx`,
   ...
   la fila "Detalle de Equipo (Historial)" de la tabla). **Aún no cerrado
   como categoría**: quedan sin clasificar `EventoDetalleModal.jsx`,
   `HistorialModal.jsx`, `OrdenCasillasForm.jsx`,
   ...
   tienen el bug). Candidato del próximo ciclo: `EventoDetalleModal.jsx`
   o `HistorialModal.jsx` (ambos con `bg-blue-600` sin clasificar).
