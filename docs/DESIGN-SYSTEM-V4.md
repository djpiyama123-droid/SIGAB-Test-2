...
3. Aplicar el mismo criterio de "sin colores fijos que dependan del fondo"
   ...
   (ver tabla de avance) — sigue pendiente el resto del layout (tabs de
   expediente/timeline en el screen ID móvil) y las 4 variantes de Reservas
   sin elegir.
