...
3. Aplicar el mismo criterio de "sin colores fijos que dependan del fondo"
   ...
   Equipo (ver tabla de avance) — sigue pendiente el resto del layout
   (variantes desktop) y las 4 variantes de Reservas sin elegir.
