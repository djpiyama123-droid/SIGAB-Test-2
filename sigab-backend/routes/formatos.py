    ...
    async with db.acquire() as conn:
        row = await conn.fetchrow(
            ...
            SELECT
                ...
                o.fecha_creacion, o.fecha_cierre, o.condicion_final,
                o.horas_uso_acumuladas, o.antiguedad_equipo, o.indice_salud,
                o.probabilidad_falla, o.ventana_recomendada, o.confianza_modelo,
                o.componente_riesgo, o.indicadores_monitoreados, o.validacion_ia,
